...
export const CodeBracketIcon = ({ className = '', ...props }: IconProps) => (
  <svg
    className={className}
    {...props}
    xmlns="http://www.w3.org/2000/svg"
...
export const SparklesIcon = ({ className = '', ...props }: IconProps) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0m-11.314 0a5 5 0 007.072 0"
    />
  </svg>
)

export const PathIcon = ({ className = '', ...props }: IconProps) => (
  <svg
    className={className}
    {...props}
    xmlns="http://www.w3.org/2000/svg"
...
export const TemplateIcon = ({ className = '', ...props }: IconProps) => (
  <svg
    className={className}
    {...props}
    xmlns="http://www.w3.org/2000/svg"
...
export const ChatIcon = ({ className = '', ...props }: IconProps) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.117C2.672 15.145 2 13.513 2 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
    />
  </svg>
)

export const PersonCircleIcon = ({ className = '', ...props }: IconProps) => (
  <svg
    className={className}
    {...props}
    xmlns="http://www.w3.org/2000/svg"
